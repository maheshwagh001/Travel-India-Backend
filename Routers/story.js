...
router.post("/addstory" ,[getAccessToRoute, uploader.single("image")],addStory)
...
router.put("/:slug/edit",[getAccessToRoute,checkStoryExist,checkUserAndStoryExist, uploader.single("image")] ,editStory)
